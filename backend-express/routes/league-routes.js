 ...
 */
router.get("/leagues/match_schedule/:league_name", async (req, res) => {
 ...
 */
router.get("/leagues/standings/:league_name", async (req, res) => {
...
router.get("/leagues/data/:league_name", async (req, res) => {
    const leagueName = req.params.league_name;
...
router.get("leagues/data/bans/:league_name", async (req, res) => {
    const leagueName = req.params.league_name;
    const result = await MatchSchedule.findAll({
        // attributes: [
        //     'Team1Bans',
        //     'Team2Bans',
        // ],
